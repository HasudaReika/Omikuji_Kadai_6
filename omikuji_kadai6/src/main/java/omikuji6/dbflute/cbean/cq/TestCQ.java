...
import omikuji6.dbflute.cbean.cq.bs.BsTestCQ;

/**
 * The condition-query of test.
 * <p>
 ...
 */
public class TestCQ extends BsTestCQ {
     ...
     */
    public TestCQ(ConditionQuery referrerQuery, SqlClause sqlClause, String aliasName, int nestLevel) {
