...
/**
 * The entity of UnseiPastSixMonths.
 * @author DBFlute(AutoGenerator)
 */
public abstract class BsUnseiPastSixMonths extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return omikuji6.dbflute.bsentity.customize.dbmeta.UnseiPastSixMonthsDbm.getInstance();
    }

    /** {@inheritDoc} */
    public String asTableDbName() {
        return "UnseiPastSixMonths";
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsUnseiPastSixMonths) {
            BsUnseiPastSixMonths other = (BsUnseiPastSixMonths)obj;
    ...
    @Override
    public UnseiPastSixMonths clone() {
        return (UnseiPastSixMonths)super.clone();
    }
