...
/**
 * The entity of ByPostCode.
 * @author DBFlute(AutoGenerator)
 */
public abstract class BsByPostCode extends AbstractEntity implements CustomizeEntity {
    ...
    public DBMeta asDBMeta() {
        return omikuji6.dbflute.bsentity.customize.dbmeta.ByPostCodeDbm.getInstance();
    }
    ...
    protected boolean doEquals(Object obj) {
        if (obj instanceof BsByPostCode) {
            BsByPostCode other = (BsByPostCode)obj;
    ...
    @Override
    public ByPostCode clone() {
        return (ByPostCode)super.clone();
    }
